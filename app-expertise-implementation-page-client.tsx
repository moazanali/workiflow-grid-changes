...
import { Settings, ArrowRightLeft, Layers, Rocket, FileText, ArrowRight, Shield } from "lucide-react"
import { serviceSchema, breadcrumbSchema } from "@/lib/schema"

const jsonLd = [
  serviceSchema({
    name: "Implementation & Setup",
    description: "Platform configuration, data migration, system architecture, and go-live support. We build your technology foundation so your team can hit the ground running.",
    slug: "/expertise/implementation",
    serviceType: "Technology Implementation",
  }),
  breadcrumbSchema([
    { name: "Home", url: "/" },
    { name: "Expertise", url: "/expertise" },
    { name: "Implementation", url: "/expertise/implementation" },
  ]),
]
...
const capabilities = [
  {
    ...
    description: "Workspaces, boards, pipelines, permissions, and automations — configured to match your business processes, not generic templates.",
    hoverColor: "var(--gradient-blue)",
  },
  {
    icon: ArrowRightLeft,
    title: "Data Migration",
    description: "Clean migration from spreadsheets, legacy systems, or other platforms. Data mapping, deduplication, and validation included.",
    hoverColor: "var(--gradient-teal)",
  },
  {
    icon: Layers,
    title: "System Architecture",
    description: "How your platforms connect, how data flows between them, and how permissions are structured at scale.",
    hoverColor: "var(--gradient-purple)",
  },
  {
    icon: Rocket,
    title: "Go-Live Support",
    description: "Hands-on support during launch. We monitor, troubleshoot, and adjust in real-time so your rollout is smooth.",
    hoverColor: "var(--gradient-pink)",
  },
  {
    icon: FileText,
    title: "Documentation",
    description: "Every implementation is documented — process guides, system maps, and admin references your team can use independently.",
...
const steps = [
  {
    number: "01",
    title: "Design",
    description: "We translate your strategy into a technical blueprint — platform structure, data model, and integration architecture.",
    textClass: "gradient-text-blue-teal",
  },
  {
    number: "02",
    title: "Build",
    description: "We configure everything, migrate your data, set up automations, and test thoroughly before anyone touches it.",
    textClass: "gradient-text-purple-pink",
  },
  {
    number: "03",
    title: "Launch",
    description: "Phased rollout with training, documentation, and real-time support. No big-bang surprises.",
...
export default function ImplementationPageClient() {
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      <HeroGrid
        badge="Expertise"
        title={<>Built the right way <span className="gradient-text-purple-pink">from day one</span>.</>}
        description="Platform configuration, data migration, system architecture, and go-live support. We build your technology foundation so your team can hit the ground running."
      />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[55%_45%] gap-12 lg:gap-16">
                  <div>
                    ...
                    <div className="space-y-4 text-muted-foreground text-base leading-[1.7]">
                      <p>
                        A tool is only as good as how it&apos;s set up. We&apos;ve seen hundreds of implementations — and we&apos;ve rescued dozens that were done wrong the first time. Our approach is methodical: we design the architecture, configure the platforms, migrate your data cleanly, and make sure your team knows how to use everything before we step back.
                      </p>
                      <p>
                        Every implementation includes documentation, training, and a structured handoff. And if you&apos;re on a retainer, we stay on to support and optimize after launch.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center justify-center">
                    <Image
                      src="https://imwffnpvmmaddvtpzbqf.supabase.co/storage/v1/object/public/assets/images/expertise/implementation.jpg"
              ...
              <div className="p-8 sm:p-10 rounded-2xl border border-[var(--border-subtle)] relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-base sm:text-lg text-muted-foreground leading-relaxed mb-4 max-w-3xl">
                    The best implementations evolve. Through our retainer, we stay on to optimize, extend, and support your systems as your business changes.
                  </p>
      ...
      <CTASection
        title={<>Ready to implement <span className="gradient-text-blue-pink">the right way</span>?</>}
        description="Book a discovery call. We'll scope your implementation and show you our process."
