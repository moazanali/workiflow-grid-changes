...
import { Zap, Link as LinkIcon, Terminal, AlertTriangle, Shuffle, Gauge, ArrowRight, Shield } from "lucide-react"
import { serviceSchema, breadcrumbSchema } from "@/lib/schema"

const jsonLd = [
  serviceSchema({
    name: "Automation & Integration",
    description: "Cross-platform integrations, workflow automation, API development, and custom connectors. We build automations that run reliably at scale.",
    slug: "/expertise/automation",
    serviceType: "Workflow Automation",
  }),
  breadcrumbSchema([
    { name: "Home", url: "/" },
    { name: "Expertise", url: "/expertise" },
    { name: "Automation", url: "/expertise/automation" },
  ]),
]
...
const capabilities = [
  {
    ...
    description: "Multi-step automated processes that replace manual work — approvals, notifications, data updates, document generation, and more.",
    hoverColor: "var(--gradient-blue)",
  },
  {
    icon: LinkIcon,
    title: "Cross-Platform Integration",
    description: "Connect monday.com, CRMs, ERPs, payment systems, email platforms, and anything with an API into unified workflows.",
    hoverColor: "var(--gradient-teal)",
  },
  {
    icon: Terminal,
    title: "API Development",
    description: "Custom API connectors for platforms that don't have native integrations. We build the bridge.",
    hoverColor: "var(--gradient-purple)",
  },
  {
    icon: AlertTriangle,
    title: "Error Handling & Monitoring",
    description: "Every automation includes retry logic, fallback paths, error notifications, and proactive monitoring. Because automations break.",
    hoverColor: "var(--gradient-pink)",
  },
  {
    icon: Shuffle,
    title: "Data Transformation",
    description: "Data mapping, reformatting, deduplication, and enrichment between systems. Your data arrives clean on the other side.",
    hoverColor: "var(--gradient-red)",
  },
  {
    icon: Gauge,
    title: "Scenario Optimization",
    description: "We audit existing automations for performance, cost, and reliability — then optimize. Faster execution, fewer errors, lower platform costs.",
...
const steps = [
  {
    number: "01",
    title: "Map",
    description: "We document every manual process and identify the highest-impact automation opportunities.",
    textClass: "gradient-text-blue-teal",
  },
  {
    number: "02",
    title: "Build",
    description: "We design, develop, and test automation scenarios with full error handling before anything goes live.",
    textClass: "gradient-text-purple-pink",
  },
  {
    number: "03",
    title: "Monitor",
    description: "We track performance, catch failures early, and optimize continuously. Automations are living systems, not set-and-forget.",
...
export default function AutomationPageClient() {
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      <HeroGrid
        badge="Expertise"
        title={<>Automation that <span className="gradient-text-blue-teal">runs reliably</span> at scale.</>}
        description="Cross-platform integrations, workflow automation, API development, and custom connectors. We build automations that work when you're not watching."
      />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[55%_45%] gap-12 lg:gap-16">
                  <div>
                    ...
                    <div className="space-y-4 text-muted-foreground text-base leading-[1.7]">
                      <p>
                        There&apos;s a difference between a demo automation and one that handles 10,000 records without failing. We build the second kind. Using Make.com, n8n, and custom API development, we connect your platforms, automate your repetitive processes, and build error handling that keeps everything running.
                      </p>
                      <p>
                        Our automation work covers everything from simple notifications to complex multi-step scenarios that orchestrate actions across a dozen tools. Every automation we build includes monitoring, error handling, and documentation.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center justify-center">
                    <Image
                      src="https://imwffnpvmmaddvtpzbqf.supabase.co/storage/v1/object/public/assets/images/expertise/automation.jpg"
                      alt="Automation and integration visualization"
                      priority
                      width={500}
                      height={400}
                      placeholder="blur"
              ...
              <div className="p-8 sm:p-10 rounded-2xl border border-[var(--border-subtle)] relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl sm:text-3xl font-bold text-foreground mb-4 tracking-[-0.02em]">
                    Automation needs ongoing attention.
                  </h3>
                  <p className="text-base sm:text-lg text-muted-foreground leading-relaxed mb-4 max-w-3xl">
                    The most reliable automations are the ones that are monitored and maintained. Our retainer includes continuous optimization, error management, and new automation development as your needs evolve.
                  </p>
      ...
      <CTASection
        title={<>Ready to automate <span className="gradient-text-blue-pink">the right way</span>?</>}
        description="Book a discovery call. We'll identify your automation opportunities and show you what's possible."
